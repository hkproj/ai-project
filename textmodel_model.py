...
class ItaLipModel(nn.Module):
    ...
    def __init__(self, vocab_size, src_seq_len=200, tgt_seq_len=200, dropout=0.2, d_model=512, nhead=8, num_encoder_layers=6, dim_ff=2048, padding_idx=0) -> None:
        super().__init__()
        ...
        self.src_embedding = nn.Embedding(num_embeddings=vocab_size, embedding_dim=d_model, padding_idx=padding_idx)
